# Generated by Django 5.0.5 on 2024-07-18 16:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estd_formacion', models.CharField(choices=[('AUXILIAR', 'Auxiliar'), ('CURSO ESPECIAL', 'Curso especial'), ('EVENTO', 'Evento'), ('OPERARIO', 'Operario'), ('TÉCNICO', 'Técnico'), ('TECNÓLOGO', 'Tecnólogo'), ('PROFUNDIZACION', 'Profundizacion'), ('BILINGUISMO', 'Bilinguismo'), ('SIN_BILINGUISMO', 'Sin_bilinguismo')], max_length=100)),
